...
#总金额
money=253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+\
...
money=round(money,2)    #round用来修饰计算机进制转化造成的误差
print("销售总金额为：￥",money)

print("")

#销售总数量
amount=10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78 #总销售数量

#平均每日销售数量
average=amount/30
average=round(average,2)
print("平均每日销售数量为：￥",average)

#不同种类销售数量占比
Myurongfu=(10+69+140+10+10)/amount*100
Mniuzaiku=(60+72+35+90+60+60+140)/amount*100
Mfengyi=(43+25+43+60+43+78)/amount*100
Mpicao=(63+24+63+57)/amount*100
MTxue=(63+45+129+63+58+48+63)/amount*100
Mchenshan=120/amount*100

Myurongfu=round(Myurongfu,2)
Mniuzaiku=round(Mniuzaiku,2)
Mfengyi=round(Mfengyi,2)
Mpicao=round(Mpicao,2)
MTxue=round(MTxue,2)
Mchenshan=round(Mchenshan,2)


print("羽绒服销售占比",Myurongfu,"%")
print("牛仔裤销售占比",Mniuzaiku,"%")
print("风衣服销售占比",Mfengyi,"%")
print("皮草服销售占比",Mpicao,"%")
print("T恤服销售占比",MTxue,"%")
print("衬衫服销售占比",Mchenshan,"%")
